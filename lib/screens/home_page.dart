          ...
          case ConnectionState.done:
            if (snapshot.hasError) {
              ...
              if (!snapshot.hasData) {
                ...
                homeProductBlock.fetchProducts
                    .add(productsCategories[0].category_id);
              ...
              itemBuilder: (context, position) {
                return InkWell(
                  ...
                  child: Card(
                    ...
                    child: Container(
                      child: Image(
                        loadingBuilder: (BuildContext context, image,
    ...
    for (var i = 0; i < qty; i++) {
      widgets.add(
        Container(
            decoration: BoxDecoration(
                color: (i == index)
                    ? ScreenUtilties.mainBlue
                    : ScreenUtilties.lightGrey,
